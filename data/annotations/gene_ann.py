...
def extract_bounding_boxes(segmentation_path, csv_path, target_classes, min_area=10):
    ...
    Parameters:
        ...
        target_class_names (set or list): Only process classes whose names are in this set.
    ...
    Returns:
        annotations (list): A list of dictionaries with keys:
            ...
            'category'     : The class name from the CSV mapping.
    ...
    rgb_mapping = {}  # keys: (r, g, b), value: class_name
...
#         {'bbox': [389, 437, 16, 39], 'category': 'Bicyclist'},
#         {'bbox': [356, 446, 13, 45], 'category': 'Pedestrian'},
#         {'bbox': [282, 442, 7, 38], 'category': 'Pedestrian'},
#         {'bbox': [317, 438, 10, 66], 'category': 'Pedestrian'},
#         {'bbox': [336, 436, 19, 68], 'category': 'Pedestrian'},
#         {'bbox': [290, 432, 23, 78], 'category': 'Pedestrian'},
#         {'bbox': [56, 369, 81, 241], 'category': 'Pedestrian'}
#     ]
...
def create_coco_json(image_dir, segmentation_dir, csv_path, target_classes, output_json):
    ...
    for class_names in target_classes:
        coco["categories"].append({
            "name": f"class_{class_names}"  # or use actual names if available
        })
...
if __name__ == "__main__":
    ...
    output_json = 'data/annotations/trian_anns'
